...
export function AiChatInput({
  ...
  return (
    <div className="rounded-[28px] border border-emerald-100 bg-white/95 p-3 shadow-[0_16px_40px_rgba(16,185,129,0.08)] backdrop-blur dark:border-emerald-900/40 dark:bg-slate-900/70 dark:shadow-[0_0_30px_rgba(16,185,129,0.08)] dark:backdrop-blur-xl">
            ...
            className={`min-h-14 w-full resize-none rounded-2xl border bg-slate-50 px-4 py-3 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:bg-white focus:ring-4 disabled:cursor-not-allowed disabled:opacity-60 dark:border-slate-800 dark:bg-slate-950/70 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:bg-slate-900/80 ${
              isAtLimit
                ...
                : isNearLimit
                  ...
                  : "border-slate-200 focus:border-emerald-400 focus:ring-emerald-100 dark:focus:border-emerald-700 dark:focus:ring-emerald-900/40"
            }`}
            disabled={isLoading}
          />
        </label>
