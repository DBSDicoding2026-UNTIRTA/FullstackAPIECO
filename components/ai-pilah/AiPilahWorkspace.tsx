...
export function AiPilahWorkspace({ text, chatText, language }: AiPilahWorkspaceProps) {
  return (
    <div className="min-w-0 space-y-6">
      <section
        id="chat-ai"
        className="overflow-hidden rounded-[32px] border border-emerald-100/80 bg-white/85 shadow-[0_24px_80px_rgba(16,185,129,0.12)] backdrop-blur scroll-mt-24 dark:border-emerald-900/40 dark:bg-slate-900/70 dark:shadow-[0_0_30px_rgba(16,185,129,0.08)] dark:backdrop-blur-xl"
      >
        <div className="px-6 py-7 sm:px-8 sm:py-8">
          ...
          <p className="mt-3 inline-flex rounded-full border border-emerald-200 bg-emerald-50 px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-emerald-700 dark:border-emerald-900/40 dark:bg-emerald-950/40 dark:text-emerald-300">
